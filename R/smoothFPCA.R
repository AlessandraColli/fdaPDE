...
#' }
#' @description This function implements a smooth functional principal component analysis for data defined over a planar mesh, or
#' a smooth manifold. For details on the model see Lila et al. 2016.
